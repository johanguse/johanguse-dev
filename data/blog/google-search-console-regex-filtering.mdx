...
draft: false
summary: 'Learn how to use regex patterns in Google Search Console to identify queries that likely came from AI tools like ChatGPT, Perplexity, or Google AI Overviews.'
images: ['/static/images/google-search-console-regex.jpg']
authors: ['default']
---
