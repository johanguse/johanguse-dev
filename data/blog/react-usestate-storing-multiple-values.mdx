---
title: 'Using React useState to storing multiple values'
date: '2024-04-08'
lastmod: '2024-04-08'
tags: ['react', 'frontend']
draft: false
...
Alright, check this out: today, I'm digging into some funky code just to get a button spinning when it's loading. Got two buttons chillin' on my page, and the last developer went all out and made two separate useState functions just to toss a loading spinner on each one. Talk about going overboard! But hey, let me walk you through the code:
...
Is this weird? Setting up two states like this totally goes against the buddy system, you know, like the whole "Don't Repeat Yourself" [DRY](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself) vibe. Instead, I'm thinking I'll just reuse the same setState and stick to one hook. Much cleaner, right?
